...
namespace aoc\advent_of_code\y2021\day_06;
 ...
 *
 * Class Lanternfish
 * @package aoc\advent_of_code\y2021\day_06
 */
class Lanternfish
{
   ...
   *
   */
  private function next_population(): void
  {
   ...
   * @param string $file
   */
  private function load_initial(string $file): void
  {
