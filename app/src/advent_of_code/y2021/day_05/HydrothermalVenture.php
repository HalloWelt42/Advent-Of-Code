...
namespace aoc\advent_of_code\y2021\day_05;


use aoc\advent_of_code\y2021\day_05\helper\Field2d;
use SplFileObject;
...
//    print_r($this->field_2d->show_all());
   ...
   * @return bool
   */
  private function check_diagonal(int $x1, int $y1, int $x2, int $y2): bool
  {
      return $x1 === $x2 || $y1 === $y2;
  }
